...
namespace Scommerce\GoogleTagManagerPro\Model\Plugin\Catalog\Controller\Category;
...
/**
 * Class ViewPlugin
 * @package Scommerce\GoogleTagManagerPro\Model\Plugin\Catalog\Controller\Category
 */
class ViewPlugin
{
    /**
    ...
    public function afterExecute(View $subject, $result)
    {
        ...
        $this->_gtmSession->setLastCategoryId($this->_helper->getCategoryPath($category));
